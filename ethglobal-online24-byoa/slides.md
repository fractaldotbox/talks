...
<img border="rounded" class="avatar-rounded" src="/image-11.png" style="height:150px;width:150px;" alt=""> 
</div> -->
---
---

## On-chain NPCs for Autonomous world

### I Built a simple game for demo

- Your own game rules on your server
- Agent use on-chain rules to decide action
- Update contract state given game state
...
## Arch
<img src="/image-10.png" style="height: 400px;" alt="">
...
- Lit action / Shadow EOA at custotidal
- server demo
...
- https://github.com/debuggingfuture/byoa/blob/master/apps/webapp/src/components/Inbox.tsx
...
sequenceDiagram
    Server->Contract: Request Action
    Server->Contract: Read Action
    Contract-->>CF: Request Game State
    CF->Server: Read Game State
    CF->Contract: Update 
...
Envio is used to load logs events, including
- contract

- https://github.com/debuggingfuture/byoa/blob/master/packages/server/src/data.service.ts
...
- Low-code tool
- use AI to generate on-chain AI agent
...
- To benefit from SOTA (State-of-the-Art) AIs
  -  Model architectures, System prompt
  
- challenges of on-chain AI
  - coordinating with latency 
  - guardrails / aciton space
...
- Foundry / Pre-compiled contract

## Technical Architecture
- FE: Rainbowkit / Wagmi / React-flow
<!--
